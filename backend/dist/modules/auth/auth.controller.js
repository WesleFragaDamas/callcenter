...
var jwt = require('jsonwebtoken'); // 1. Importe a nova biblioteca

var login = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(req, res) {
    var _req$body, username, password, userQuery, _yield$db$query, rows, user, isPasswordValid, payload, token, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 5:
          ...
          console.log("Token gerado para o usu\xE1rio: ".concat(user.username));
        ...
        case 6:
          _context.p = 6;
          _t = _context.v;
          console.error('Erro no processo de login:', _t);
          res.status(500).json({
